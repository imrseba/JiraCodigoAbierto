...
def crear_hito_app(clave_acceso):
    ...
    if selected_sprint:
        ...
        # Verificar si la fecha actual es al menos 1 día antes de la fecha de entrega del sprint
        ...
        if dias_restantes < 0:
            st.error("No se puede agregar el hito. Debe ser al menos 1 día antes de la fecha de entrega del sprint.")
        else:
